...
| **2102** | **神代の守護竜**<br>(`enemy_boss_ep10_dragon`) | Lv.25<br>HP: 1800 | ATK: 55<br>DEF: 18 | 0 EXP<br>0 G | - | quest_only | ・**竜の息吹** (50%)<br>・**雷撃** (20%)<br>・**ホーリーレイ** (HP50%以下で80%発動)<br>・**自己再生** (HP30%以下で100%発発動) |
