...
3. **③ 魔術学院でのカード契約確認ナビ**:
   - 条件: 第1話クリア ＆ 同行メンバー 1人以上 ＆ ギルド訪問済 ＆ 魔術学院未訪問 (`!visitedAcademy`)
   - バナー: 「💡 旅の目的: 「魔術学院」で新たな魔導の契約（カードパック購入）やデッキの確認をしましょう！」
   - 推奨施設: `academy` (魔術学院) をハイライト。
4. **④ 道具屋・チャージの確認ナビ**:
   - 条件: 第1話クリア ＆ 同行メンバー 1人以上 ＆ ギルド訪問済 ＆ 魔術学院訪問済 ＆ 道具屋/チャージ未訪問 (`!visitedShop` または `!visitedBilling`)
   - バナー: 「💡 旅の目的: 「道具屋」や「チャージ」を開いて、冒険に役立つアイテムや金貨を確認しましょう！」
   - 推奨ボタン/施設: `shop` (道具屋) の施設ボタンおよびヘッダーのゴールドチャージボタンをハイライト。
5. **⑤ ステータス画面の確認ナビ**:
   - 条件: 第1話クリア ＆ 同行メンバー 1人以上 ＆ ギルド訪問済 ＆ 魔術学院訪問済 ＆ 道具屋/チャージ訪問済 ＆ ステータス未確認 (`!visitedStatus`)
   - バナー: 「💡 旅の目的: 「ステータス」を開いて、キャラクターの能力値や装備品を確認しましょう！」
   - 推奨ボタン: ヘッダーまたはメニューの `ステータス (Status)` 関連ボタンをハイライト。
6. **⑥ 各種設定の確認ナビ**:
   - 条件: 第1話クリア ＆ 同行メンバー 1人以上 ＆ ギルド訪問済 ＆ 魔術学院訪問済 ＆ 道具屋/チャージ訪問済 ＆ ステータス訪問済 ＆ 設定未確認 (`!visitedSettings`)
   - バナー: 「💡 旅の目的: 「設定（歯車マーク）」を開いて、音量調節やアカウント管理の機能を確認しましょう！」
   - 推奨ボタン: ヘッダーの `設定 (Cog)` ボタンをハイライト。
7. **⑦ ワールドマップでの冒険開始ナビ**:
   - 条件: 第1話クリア ＆ 同行メンバー 1人以上 ＆ ギルド・魔術学院・商店・ステータス・設定の全施設/画面訪問済 ＆ マップ未訪問 (`!visitedMap`)
