...
- **PC表示幅制限と共通コンテナ**: PCなどの大画面でボタンの巨大化やレイアウトの引き伸ばしを防ぐため、工房全体を `max-w-[450px]` の枠に制限し、アンティーク調のウッドブラウン境界線（`md:border-4 md:border-[#3e2723] md:rounded-[24px]`）で囲み画面中央に配置する
