...
「狭間の迷宮」シリーズ（7060〜7066）で登場する新悪魔エネミー。`spawn_type: quest_only`。

### 雑魚エネミー (10体)

| # | キャラクタ名 | ID (slug) | Lv | HP | ATK | DEF | EXP | Gold |
|---|---|---|---|---|---|---|---|---|
| 1 | インプ | `enemy_rift_imp` | 7 | 180 | 18 | 10 | 25 | 30 |
| 2 | ヘルハウンド | `enemy_rift_hellhound` | 8 | 220 | 22 | 8 | 30 | 40 |
| 3 | ヘルウィング | `enemy_rift_hellwing` | 8 | 200 | 20 | 8 | 30 | 40 |
| 4 | サキュバス | `enemy_rift_succubus_rift` | 10 | 260 | 22 | 12 | 40 | 60 |
| 5 | デーモンメイジ | `enemy_rift_mage` | 10 | 230 | 18 | 10 | 40 | 60 |
| 6 | プレイグデーモン | `enemy_rift_plague` | 12 | 320 | 26 | 15 | 50 | 80 |
| 7 | デーモンソルジャー | `enemy_rift_soldier` | 12 | 380 | 30 | 20 | 50 | 80 |
| 8 | シャドウデーモン | `enemy_rift_shadow` | 14 | 280 | 36 | 10 | 60 | 100 |
| 9 | アークデーモン | `enemy_rift_archdemon` | 14 | 450 | 40 | 18 | 80 | 120 |
| 10 | グレーターデーモン | `enemy_rift_greater_demon` | 18 | 520 | 45 | 25 | 120 | 180 |

### ボスエネミー (6体)

| # | キャラクタ名 | ID (slug) | Lv | HP | ATK | DEF | EXP | Gold | 出現クエスト |
|---|---|---|---|---|---|---|---|---|---|
| 1 | 深淵の狂皇 アスタロト | `boss_rift_astaroth` | 10 | 2400 | 52 | 30 | 300 | 800 | 7062 (中層) |
| 2 | 生贄の番人 ゲレゲール | `boss_rift_gereger` | 14 | 3000 | 62 | 40 | 500 | 1200 | 7063 (下層・悪) |
| 3 | 光なき思念 アケロン | `boss_rift_acheron` | 14 | 2600 | 58 | 25 | 500 | 1200 | 7063 (下層・正義) |
| 4 | 魔導士ヴァルグナ | `boss_rift_vargna` | 15 | 4200 | 70 | 50 | 800 | 2000 | 7063 (下層最深部) |
| 5 | 魔導士ヴァルグナ（真） | `boss_rift_vargna_true` | 18 | 5000 | 80 | 60 | 1200 | 3000 | 7065 (深淵) |
| 6 | 破壊神 サタン | `boss_rift_satan` | 20 | 6000 | 95 | 75 | 2000 | 5000 | 7065 (深淵) |
