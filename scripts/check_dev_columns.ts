...
async function run() {
    ...
    console.log("Fetching one row from user_profiles on dev DB to inspect columns...");
    ...
    console.log('Columns found in user_profiles on dev DB:', data ? Object.keys(data[0] || {}) : 'no data');
}
