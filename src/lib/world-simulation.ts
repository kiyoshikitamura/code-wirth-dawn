...
export async function updateWorldSimulation() {
    ...
    // JST 2026-06-17 18:00:00 (UTC 2026-06-17 09:00:00)
    const RELEASE_DATE = new Date('2026-06-17T18:00:00+09:00');
    if (new Date() < RELEASE_DATE) {
        console.log('[WorldSim] Before release date (2026-06-17 18:00 JST). Skipping world simulation update.');
        return {
            success: true,
            logs: ['[WorldSim] Skipped: Before release date (2026-06-17 18:00 JST)'],
            hegemony: {}
        };
    }
