...
const BGM_FILES: Record<string, string> = {
    ...
    bgm_rift_abyss:        '/audio/bgm/bgm_rift_abyss.ogg',
};
...
export const CARD_EFFECT_SE_MAP: Record<string, string> = {
    ...
    taunt:             'se_taunt',
    escape:            'se_escape',
    // ─── 魔術学院 追加エディション効果音マッピング ───
    catharsis:              'se_magic',
    shield_slam:            'se_attack',
    pay_to_win:             'se_attack',
    double_cast:            'se_buff',
    search_light:           'se_buff',
    wound_tear:             'se_attack',
    defpless_prey:          'se_attack',
    epidemic_fog:           'se_magic',
    unyielding_wall:        'se_buff',
    sacrifice_oath:         'se_buff',
    desperado:              'se_attack',
    sacrificial_ritual:     'se_buff',
    desperate_strike:       'se_attack',
    detonation:             'se_magic',
    freeze_lancer:          'se_magic',
    chain_lightning:        'se_magic',
    prominence:             'se_magic',
    brain_spin:             'se_buff',
    recycle:                'se_buff',
    blood_pursuit:          'se_attack',
    flame_burst:            'se_magic',
    frozen_wave:            'se_magic',
    iron_bastion:           'se_buff',
    revenge_shield_card:    'se_buff',
    giant_body:             'se_buff',
    grounding:              'se_buff',
    gambler_dice:           'se_attack',
    soul_boost_card:        'se_buff',
    ruin_pact:              'se_magic',
    element_resonance_card: 'se_buff',
    plasma_shower:          'se_magic',
    absolute_zero:          'se_magic',
    fire_wave:              'se_magic',
    quick_draw:             'se_buff',
    tactical_plan:          'se_buff',
    time_reverse:           'se_buff',
    mana_filter:            'se_buff',
};
