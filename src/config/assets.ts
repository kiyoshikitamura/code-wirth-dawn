...
export const SCENARIO_ASSETS: Record<string, string> = {
    ...
    'bg_rift_lower_entrance': '/images/quests/bg_rift_lower_entrance.png',
    'bg_rift_vargna_summon': '/images/quests/bg_rift_vargna_summon.png',
    'bg_rift_trial_scales': '/images/quests/bg_rift_trial_scales.png',
    'bg_rift_vargna_throne': '/images/quests/bg_rift_vargna_throne.png',
