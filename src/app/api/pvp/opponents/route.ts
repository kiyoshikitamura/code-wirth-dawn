    ...
    C: [
        {
            ...
            party_members_snapshot: [
                { id: 'ghost_c_1_m1', name: 'ハンス', job_class: 'Guard', level: 4, hp: 100, max_hp: 100, atk: 8, def: 6, inject_cards: [2], image_url: '/images/npcs/npc_roland_guard_rookie.png' }
            ],
        ...
        },
        {
            ...
            party_members_snapshot: [
                { id: 'ghost_c_2_m1', name: 'エレナ', job_class: 'Cleric', level: 5, hp: 90, max_hp: 90, atk: 6, def: 7, inject_cards: [14], image_url: '/images/npcs/npc_roland_elena.png' }
            ],
            equipped_items_snapshot: [
    ...
    B: [
        {
            ...
            party_members_snapshot: [
                { id: 'ghost_b_1_m1', name: 'ガッツ', job_class: 'Mercenary', level: 14, hp: 280, max_hp: 280, atk: 22, def: 12, inject_cards: [1, 9], image_url: '/images/npcs/npc_free_guts.png' },
                { id: 'ghost_b_1_m2', name: 'アンナ', job_class: 'Priest', level: 12, hp: 140, max_hp: 140, atk: 8, def: 10, inject_cards: [14], image_url: '/images/npcs/npc_roland_priest_anna.png' }
            ],
            equipped_items_snapshot: [
        ...
        },
        {
            ...
            party_members_snapshot: [
                { id: 'ghost_b_2_m1', name: 'サム', job_class: 'Hunter', level: 16, hp: 200, max_hp: 200, atk: 24, def: 9, inject_cards: [3], image_url: '/images/npcs/npc_roland_hunter_sam.png' },
                { id: 'ghost_b_2_m2', name: 'ライラ', job_class: 'Dancer', level: 15, hp: 160, max_hp: 160, atk: 12, def: 8, inject_cards: [5], image_url: '/images/npcs/npc_markand_dancer_lila.png' }
            ],
            equipped_items_snapshot: [
    ...
    A: [
        {
            ...
            party_members_snapshot: [
                { id: 'ghost_a_1_m1', name: 'レオ', job_class: 'Paladin', level: 30, hp: 550, max_hp: 550, atk: 35, def: 32, inject_cards: [11, 15], image_url: '/images/npcs/npc_roland_paladin_leo.png' },
                { id: 'ghost_a_1_m2', name: 'クロヴィス', job_class: 'Scholar', level: 28, hp: 220, max_hp: 220, atk: 48, def: 18, inject_cards: [12], image_url: '/images/npcs/npc_roland_scholar.png' }
            ],
            equipped_items_snapshot: [
        ...
        },
        {
            ...
            party_members_snapshot: [
                { id: 'ghost_a_2_m1', name: 'ケンジ', job_class: 'Samurai', level: 32, hp: 480, max_hp: 480, atk: 58, def: 22, inject_cards: [25], image_url: '/images/npcs/npc_yato_ronin_kenji.png' },
                { id: 'ghost_a_2_m2', name: 'アヤメ', job_class: 'Ninja', level: 30, hp: 320, max_hp: 320, atk: 42, def: 18, inject_cards: [18], image_url: '/images/npcs/npc_yato_kunoichi.png' }
            ],
            equipped_items_snapshot: [
    ...
    S: [
        {
            ...
            party_members_snapshot: [
                { id: 'ghost_s_1_m1', name: 'ヴォルグ', job_class: 'Mercenary', level: 50, hp: 1200, max_hp: 1200, atk: 85, def: 55, inject_cards: [29, 48], image_url: '/images/npcs/npc_guest_volg.png' },
                { id: 'ghost_s_1_m2', name: 'ガウェイン', job_class: 'Knight', level: 48, hp: 980, max_hp: 980, atk: 48, def: 75, inject_cards: [9, 71], image_url: '/images/npcs/npc_guest_gawain.png' },
                { id: 'ghost_s_1_m3', name: 'レオ', job_class: 'Paladin', level: 45, hp: 800, max_hp: 800, atk: 52, def: 58, inject_cards: [15, 14], image_url: '/images/npcs/npc_roland_paladin_leo.png' }
            ],
            equipped_items_snapshot: [
